      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
        ...
        >
          ...
          <p
            ...
            data-aos-delay="500"
          >
            I have a strong interest in software development and I enjoy working on projects that combine creativity with problem-solving. Professionally, my goal is to become a software engineer with a focus on creating user-friendly applications and technologies that make a positive impact.
